...
if (isset($_POST['set_index']) && isset($_SESSION['logged_in'])) {
    ...
    if (file_exists($index_file)) {
        ...
        // 将内容写入index.html
        if (file_put_contents('index.html', $file_content) !== false) {
            $success = "首页已成功设置为 " . $index_file . " 的内容！";
        } else {
            $error = "写入index.html文件失败，请检查文件权限！";
        }
    } else {
        $error = "文件不存在，无法设置为首页";
    }
...
<head>
    ...
    <style>
        ...
        .notice {
            ...
            border-radius: 8px;
            font-size: 14px;
            box-shadow: 0 2px 8px rgba(255, 204, 102, 0.1);
        }
        
        /* 特殊链接样式 */
        .preview-link.special {
        ...
        .preview-link.special:hover {
            background-color: #ff6b9d;
            transform: translateY(-2px);
            box-shadow: 0 7px 15px rgba(255, 107, 157, 0.3);
        }
        
        .preview-link.special::after {
            content: '✨';
            margin-left: 5px;
        }
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            ...
            <div class="admin-section">
                <h2>设置网站首页</h2>
                <div class="notice">
                    <p>本系统会将您选择的文件内容复制到index.html中，使其成为首页显示的内容。</p>
                </div>
                <form method="post" action="">
                    <div class="form-group">
            ...
            <div class="admin-section">
                ...
                <div class="preview-container">
                    <div class="preview-links">
                        ...
                        <a href="index.html" target="_blank" class="preview-link special">当前首页</a>
                    </div>
                </div>
            </div>
